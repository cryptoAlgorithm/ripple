/*
Call new Ripple(elem) to add a ripple effect on click for elem. Can be any elem that accepts mouse events.
These ripples are inspired by the ripples in the React Material-UI library, but shares no code.
Version v0.5.0, GPL-v3-or-higher license
*/
